...
if(CMAKE_C_COMPILER_ID MATCHES "Clang")
    ...
    if(OQS_DEBUG_BUILD)
        ...
        elseif(USE_SANITIZER STREQUAL "Fuzzer")
            ...
            set(SANITIZER_LD_FLAGS "-fsanitize=fuzzer-no-link -fcoverage-mapping -fprofile-instr-generate")
        elseif(USE_SANITIZER STREQUAL "FuzzerWithASan")
            add_compile_options(-fsanitize=fuzzer-no-link,address)
            add_compile_options(-fcoverage-mapping)
            add_compile_options(-fprofile-instr-generate)
            set(SANITIZER_LD_FLAGS "-fsanitize=fuzzer-no-link,address -fcoverage-mapping -fprofile-instr-generate")
        elseif(USE_SANITIZER STREQUAL "FuzzerWithUBSan")
            add_compile_options(-fsanitize=fuzzer-no-link,undefined)
            add_compile_options(-fcoverage-mapping)
            add_compile_options(-fprofile-instr-generate)
            set(SANITIZER_LD_FLAGS "-fsanitize=fuzzer-no-link,undefined -fcoverage-mapping -fprofile-instr-generate")
        endif()
    else()
